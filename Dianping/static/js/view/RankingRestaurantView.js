    ...
    /* RankingResult(Restaurant) View Class*/
    (function () {
        var instance = null;
        RankingRestaurantView = function () {
            if (instance) {
                return instance;
            }
            instance = this;
            View.call(this, "rankingresultfood", ToolBar.searchConditionalResult);
            this.prototype = new View();
            this.prototype.constructor = RankingRestaurantView;

          //Tracking
            this.pageName="mycadillac:大众点评:排行榜搜索结果页面";
            this.channel="大众点评";
            ...
            this.show = function () {
                ...
                initConditionToolbar();
                $("#currentCityFlag").html("搜索城市："+(Utility.currentSearchCity));
                $("#rankingList_toolbar .selected").removeClass("selected");
